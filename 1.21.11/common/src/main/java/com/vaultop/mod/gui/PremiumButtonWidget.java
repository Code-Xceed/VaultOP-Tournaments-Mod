...
public class PremiumButtonWidget extends ClickableWidget {
    ...
    public interface PressAction {
        void onPress(PremiumButtonWidget button);
    }

    public PremiumButtonWidget(int x, int y, int width, int height, net.minecraft.text.Text message, PressAction onPress, int highlightColor, int shadowColor, int activeColor) {
